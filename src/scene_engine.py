...
def author_chunk(context: dict, chunk: str, characters: dict | None = None) -> list[dict]:
    ...
    system = (
        ...
        "moment: hands, face, posture, emotional state, or interaction. Describe: the protagonist "
        "[age range from character], [appearance/clothing from character], [spiritual/emotional "
        "state], [divine light]. Example: 'A man in his 30s wearing casual modern clothes, "
        "kneeling with hands open in surrender, face peaceful and tear-stained, bathed in soft "
        "divine light.' NO NAME EVER.\n"
